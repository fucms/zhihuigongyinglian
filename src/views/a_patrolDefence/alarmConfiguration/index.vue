  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item>
          <el-form-item label="发货ID">
            <el-input v-model="listQuery.filter1" placeholder="请输入发货ID" />
          </el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="发货ID" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code1 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="发货单位" prop="type3" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code2 }}</span>
          </template>
        </el-table-column>
